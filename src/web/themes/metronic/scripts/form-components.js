var FormComponents = function () {
    ...
    var handleWysihtml5 = function () {
        ...
        if ($('.wysihtml5').size() > 0) {
            $('.wysihtml5').wysihtml5({
                "stylesheets": ["/themes/metronic/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
            });
        }
    }
    ...
    var handleDateRangePickers = function () {
        ...
        $('#reportrange').daterangepicker({
                ...
                locale: {
                    ...
                    daysOfWeek: ['Do', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'],
    ...
    var handleInputMasks = function () {
        ...
        $("#officephone").inputmask("mask", {
            "mask": "(9999) 999-9999"
        });
        
        $("#extension_numeric").inputmask("mask", {
            "mask": "999"
        });
