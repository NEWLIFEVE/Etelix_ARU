var FormImageCrop = function () {
    ...
    var demo5 = function() {
        ...
        $('#img1').click(function(e) {
          ...
          jcrop_api.setImage('/themes/metronic/plugins/jcrop/demos/demo_files/sago.jpg');
        ...
        $('#img2').click(function(e) {
          ...
          jcrop_api.setImage('/themes/metronic/plugins/jcrop/demos/demo_files/pool.jpg');
          jcrop_api.setOptions({ bgOpacity: .6 });
          return false;
        });
        $('#img3').click(function(e) {
          ...
          jcrop_api.setImage('/themes/metronic/plugins/jcrop/demos/demo_files/sago.jpg',function(){
            this.setOptions({
              bgOpacity: 1,
              outerImage: '/themes/metronic/plugins/jcrop/demos/demo_files/sagomod.jpg'
            });
