...
class Rol extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name_rol', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'users' => array(self::HAS_MANY, 'User', 'id_rol'),
			'actionRols' => array(self::HAS_MANY, 'ActionRol', 'id_rol'),
		);
	}
	...
	public static function model($className=__CLASS__)
	{
        ...
        /**
         * Retorna los actions permitidos a un ususario
         */
        public static function getActions($controller,$idUser)
        {
            ...
            if($idUser!=null)
            {
                ...
                foreach (Users::model()->findByPk(Yii::app()->user->id)->idRol->actionRols as $values)
               {
