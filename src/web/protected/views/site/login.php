...
<!--         <div class="create-account">
      ...
      <form class="register-form" action="index.html" method="post">
         ...
         <p>Ingrese los datos de su cuenta a continuación:</p>
         <div class="form-group">
         ...
         <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Vuelva a escribir la contraseña</label>
            <div class="controls">
               <div class="input-icon">
                  <i class="icon-ok"></i>
                  <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Vuelva a escribir la contraseña" name="rpassword"/>
               </div>
            </div>
         </div>
         <div class="form-group">
            <label>
            <input type="checkbox" name="tnc"/> Estoy de acuerdo <a href="#">con los Términos del Servicio </a> y <a href="#"> la Política de Privacidad</a>
            </label>  
   ...
   <div class="copyright">
     <font color="white">Copyrigth 2014 by</font> <a id="enlacerenoc" href="http://www.etelix.com/">www.etelix.com</a>
			<font color="white"> Legal privacy Version 1.1.1.2 </font>
   </div>
